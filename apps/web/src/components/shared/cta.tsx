  ...
  return (
    <section className="flex flex-col items-center text-center px-8 py-24 bg-white relative overflow-hidden">
      ...
      <AnimatedContent distance={50} direction="vertical" delay={0.15}>
        <h2 className="font-serif text-8xl leading-none text-gray-900 flex items-center justify-center flex-wrap gap-4">
          Shop
          <div className="relative w-64 h-64 inline-block">
            <Cursor
              attachToParent
              variants={{
      ...
      <AnimatedContent distance={50} direction="vertical" delay={0.25}>
        <h2 className="font-serif text-8xl leading-none text-gray-900 mt-2">
          Not Harder.
        </h2>
      </AnimatedContent>
      ...
      <AnimatedContent distance={40} direction="vertical" delay={0.35}>
        <p className="text-gray-600 mt-8">
          Stop refreshing tabs. Let Cani watch, compare, and act for you.
          <br />
          Set your first watch in under a minute.
        </p>
      </AnimatedContent>
